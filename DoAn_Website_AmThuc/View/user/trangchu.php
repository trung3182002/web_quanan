...
<html lang="en">
    ...
    include ("../../PHP/User/PhanTrang.php");
        ...
        <div id="viewport">
            <div id="js-scroll-content">
                <section class="main-banner" id="home">
                    <div class="js-parallax-scene">
                        <div class="banner-shape-1 w-100" data-depth="0.30">
                            <img src="../../assets/user/images/berry.png" alt="">
                        </div>
                        <div class="banner-shape-2 w-100" data-depth="0.25">
                            <img src="../../assets/user/images/leaf.png" alt="">
                        </div>
                    </div>
                    <div class="sec-wp">
                        <div class="container">
                                ...
                                <div class="col-lg-6">
                                    <div class="banner-text">
                                        ...
                                        <div class="banner-btn mt-4">
                                            <a href="#menu" class="sec-btn">Menu Của Nhà Hàng</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="banner-img-wp">
                                        <div class="banner-img" style="background-image: url(../../assets/user/images/banner/banner1.jpg);">
                                        </div>
                                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="sec-title text-center mb-5">
                                        <p class="sec-sub-title mb-3">Menu Của Chúng Tôi</p>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 m-auto">
                                        <div class="menu-tab text-center">
                                            <!-- ds loai am thuc  -->                                         
                                            <?php include './pages/ds_loaiamthuc.php'; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="menu-list-row">
                                <div class="row g-xxl-5 bydefault_show" id="menu-dish">
                                    <!-- ds am thuc  -->
                                    <?php include './pages/ds_amthuc.php'; ?>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="sec-img mt-5">
                                    <img src="../../assets/user/images/pizza.png" alt="">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="sec-text">
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 order-lg-2 order-1">
                                <div class="sec-img">
                                    <img src="../../assets/user/images/sushi.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-7">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="testimonials-box">
                                                <div class="testimonial-box-top">
                                                    <div class="testimonials-box-img back-img" style="background-image: url(../../assets/user/images/testimonials/t1.jpg);">
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="testimonials-box">
                                                <div class="testimonial-box-top">
                                                    <div class="testimonials-box-img back-img" style="background-image: url(../../assets/user/images/testimonials/t2.jpg);">
                                                    </div>
                                                    <div class="star-rating-wp">
                                                        <div class="star-rating">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="testimonials-box">
                                                <div class="testimonial-box-top">
                                                    <div class="testimonials-box-img back-img" style="background-image: url(../../assets/user/images/testimonials/t3.jpg);">
                                                    </div>
                                                    <div class="star-rating-wp">
                                                        <div class="star-rating">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="testimonials-box">
                                                <div class="testimonial-box-top">
                                                    <div class="testimonials-box-img back-img" style="background-image: url(../../assets/user/images/testimonials/t4.jpg);">
                                                    </div>
                                                    <div class="star-rating-wp">
                                                        <div class="star-rating">
                ...
                <footer class="site-footer" id="contact">
                    ...
                    <div class="bottom-footer" id="about">
                        <div class="container">
                            <div class="row">
