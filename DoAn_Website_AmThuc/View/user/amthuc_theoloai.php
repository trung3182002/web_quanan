...
<html lang="en">
    ...
    include ("../../PHP/User/LayDSAmThucTheoLoai.php");
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="banner-img-wp">
                                        <div class="banner-img" style="background-image: url(../../assets/user/images/main-b.jpg);">
                                        </div>
                                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="menu-list-row">
                                <div class="row g-xxl-5 bydefault_show" id="menu-dish">
                                    <!-- ds am thuc  -->
                                    <?php include './pages/ds_amthuc_theoloai.php'; ?>
