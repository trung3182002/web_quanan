...
<html lang="en">
    ...
    include ("../../PHP/User/LayDSAmThuc.php");
    ...
    include ("../../PHP/User/LayTTDangNhap.php");
    include ("../../PHP/User/DatHang.php");
    include ("../../PHP/User/ThemDonHang.php");
            ...
            <div class="sec-wp">
                <div class="container">
                    <!-- Thong tin khach hang  -->
                     <?php include './pages/chitiet_dathang.php'; ?>
